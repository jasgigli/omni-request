...
export type MiddlewareFunction = (config: RequestConfig) => Promise<RequestConfig>;
export type ResponseMiddlewareFunction = (response: ResponseData) => Promise<ResponseData>;
export type ErrorMiddlewareFunction = (error: any, config: RequestConfig) => Promise<RequestConfig | ResponseData>;
